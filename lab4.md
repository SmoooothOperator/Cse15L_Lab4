...
![Image](Step 4.png) <br>
Keys pressed: ssh,<space>,cs15lfa23bu@ieng6.ucsd.edu <br>
...
![Image](Step 5.png) <br>
Keys pressed: cd,<space>,lab4,git,<space>,clone,<space>,https://github.com/SmoooothOperator/lab7.git
...
![Image](Step 6.png) <br>
Keys pressed: cd,<space>,lab7,bash,<space>,test.sh <br>
...
![Image](Step 7.png) <br>
Keys pressed: vim,<space>,ListExamples.java,G,k,k,k,k,k,k,l,l,l,l,l,l,l,l,l,l,l,x,i,2,<esc>,:w <br>
...
![Image](Step 8.png) <br>
Keys pressed: :q,<up>,<up>,<up>,<enter> <br>
...
![Image](Step 9.png) <br>
Keys pressed: git,<space>,add,<space>,.,git,<space>,commit,<space>,-m,<space>,"fixed_error",git,<space>,push <br>
